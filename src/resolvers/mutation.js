...
module.exports = {
    ...
    newNote: async (parent, args, {models, user}) => {
        //if there is no new user on the context, throw an authentication error
        if (!user) {
    ...
    updateNote: async (parent, {content, id}, {models, user}) => {
        //if not a user, throw an Authentication Error
        if (!user) {
            throw new AuthenticationError('Ypu must be signed in to update a note')
        }
    ...
    signIn: async (parent, {username, email, password}, {models}) => {
        ...
        if (!user) {
            throw new AuthenticationError('No such user is found')
        }
